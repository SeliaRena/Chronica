...
class AppUsageItemWidget(QFrame):
    def __init__(self, data: AppUsageItemData, app_icon_provider: AppIconProvider, parent: QWidget | None = None):
        ...
        progress_rows_layout.setContentsMargins(0, 0, 0, 0)
        ...
        window_items_layout.setContentsMargins(12, 12, 12, 12)
        window_items_layout.setSpacing(12)
        ...
        self.setStyleSheet(Stylesheets.load("usage_report", "app_usage_item_widget.qss"))