...
class RecentSessionsItemWidget(QWidget):
    ...
    def __init__(self, data: RecentSessionsItemData, parent: QWidget | None = None):
        ...
        self.end_time_label.setObjectName("endTimeLabel")
        ...
        self.session_chip.setFrameStyle(QFrame.Shape.StyledPanel | QFrame.Shadow.Raised)
        ...
        # 3-1r-1 Chip Icon
        chip_icon = QIcon(str(ResourceLocator.ui_icon("history.png")))
        self.chip_icon_label = QLabel()
        self.chip_icon_label.setObjectName("chipIconLabel")
        ...
        self.chip_app_name_label.setObjectName("chipAppNameLabel")
        
        self.chip_duration_label = ElidedLabel(self.data.duration)
        self.chip_duration_label.setObjectName("chipDurationLabel")
        
        # First Row Layout
        first_row = QWidget()
        first_row.setObjectName("firstRow")
        ...
        self.chip_window_title_label.setObjectName("chipWindowTitleLabel")
        ...
        self.setStyleSheet(load_stylesheet("recent_sessions_item_widget"))